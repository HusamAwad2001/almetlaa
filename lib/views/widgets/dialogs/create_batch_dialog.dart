...
class CreateBatchDialog{
  static show(){
    Get.bottomSheet(GetBuilder<ConstructionBillsController>(
      builder: (controller) {
        return Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            25.ph,
            const Text("دفعة جديدة",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Constants.primaryColor),),
            25.ph,
            TextFieldWidget(
    ...
    ),backgroundColor: Colors.white,isScrollControlled: false);
  }
}