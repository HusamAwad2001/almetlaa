import 'package:almetlaa/controller/videos_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("الفيديو",style: TextStyle(color: Colors.white),),
        ...
        child: Column(
          children: [
            ...
            GetBuilder<VideosController>(
              ...
              builder: (controller) {
                return controller.loadingVideos? const VideosShimmer() : controller.videos.isEmpty? const Text("لا يوجد بيانات").paddingOnly(top: Get.height/3.5) : ListView.separated(
                  shrinkWrap: true,
